...
///============================================//
    "un_database_check" addPublicVariableEventHandler 
	{
		...
		_datanamearray = format ["(%1)_(%2)_(Inidbi2-TEMPLATE-ALTIS)", _dataplayrname, _dataplayruid];
...
///============================================//
    ...
    "un_database_save" addPublicVariableEventHandler 
	{
		private ["_packet"];
        _packet = _this select 1;
        _datanamearray = format ["(%1)_(%2)_(Inidbi2-TEMPLATE-ALTIS)", _packet select 0, _packet select 1];
        _databasename = _datanamearray;
        _inidbiUN = ["new", _databasename] call OO_INIDBI;
